...
import 'package:todo/data/notes/update_notes_fun.dart';
...
class _NoteDetailsState extends State<NoteDetails> {
  ...
  var note_id = Get.arguments['note_id'];
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          InkWell(
            onTap: () {
              if (changed == true && form.currentState!.validate()) {
                update_notes_fun(title_con.text, body_con.text, note_id);
              } else {}
            },
            child: Container(
        ...
        title: AnimatedTextKit(
          totalRepeatCount: 1,
          animatedTexts: [
            TyperAnimatedText("Note details",
